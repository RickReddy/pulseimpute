...
files = []
with open("data/pulseimpute_data/waveforms/nki_resp/nki_resp_good_files.txt") as text_file:
...
np.save('data/pulseimpute_data/waveforms/nki_resp/nki_resp_test.npy', array)
