...
files = []
with open("/home/guntakrr/og-pulseimpute/data/pulseimpute_data/waveforms/eegfmri_nih_ppg/eegfmri_nih_ppg_good_files.txt") as text_file:
...
np.save('/home/guntakrr/og-pulseimpute/data/pulseimpute_data/waveforms/eegfmri_nih_ppg/eegfmri_nih_ppg_test.npy', array)