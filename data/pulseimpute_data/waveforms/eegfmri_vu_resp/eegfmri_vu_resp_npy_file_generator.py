...
files = []
with open("data/pulseimpute_data/waveforms/eegfmri_vu_resp/eegfmri_vu_resp_good_files.txt") as text_file:
...
np.save("data/pulseimpute_data/waveforms/eegfmri_vu_resp/eegfmri_vu_resp_test.npy", array)
