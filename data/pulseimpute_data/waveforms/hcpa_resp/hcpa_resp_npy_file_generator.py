...
files = []
with open("data/pulseimpute_data/waveforms/hcpa_resp/hcpa_resp_good_files.txt") as text_file:
...
np.save('data/pulseimpute_data/waveforms/hcpa_resp/hcpa_resp_test.npy', array)
