...
files = []
with open("/home/guntakrr/og-pulseimpute/data/pulseimpute_data/waveforms/hcpa_resp/hcpa_resp_good_files.txt") as text_file:
...
np.save('/home/guntakrr/og-pulseimpute/data/pulseimpute_data/waveforms/hcpa_resp/hcpa_resp_test.npy', array)