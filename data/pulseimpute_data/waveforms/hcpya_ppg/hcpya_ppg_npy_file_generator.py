...
files = []
with open("data/pulseimpute_data/waveforms/hcpya_ppg/hcpya_ppg_good_files.txt") as text_file:
...
np.save('data/pulseimpute_data/waveforms/hcpya_ppg/hcpya_ppg_test.npy', array)
